...
| `sensor`        | Show info from cFos Powerbrain API. |
...
```text
custom_components/powerbrain/translations/en.json
custom_components/powerbrain/translations/fr.json
custom_components/powerbrain/translations/nb.json
custom_components/powerbrain/translations/sensor.en.json
custom_components/powerbrain/translations/sensor.fr.json
custom_components/powerbrain/translations/sensor.nb.json
custom_components/powerbrain/translations/sensor.nb.json
custom_components/powerbrain/__init__.py
custom_components/powerbrain/api.py
custom_components/powerbrain/binary_sensor.py
custom_components/powerbrain/config_flow.py
custom_components/powerbrain/const.py
custom_components/powerbrain/manifest.json
custom_components/powerbrain/sensor.py
custom_components/powerbrain/switch.py
```
